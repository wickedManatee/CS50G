    ...
    :finish(function()
        ...
        function()
            ...
            local exp = (self.opponentPokemon.HPIV + self.opponentPokemon.attackIV +
                self.opponentPokemon.defenseIV + self.opponentPokemon.speedIV) * self.opponentPokemon.level -- * 10
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local hp, atk, def, spd = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
							function() end, false
						))
						gStateStack:push(LevelupMenuState(self.playerPokemon, hp, atk, def, spd, 
							function() 
								self:fadeOutWhite()
							end))
                    else
