...
function Pokemon:init(def, level)
	...
	--print(self.name .. '      ' .. ' hp ' .. self.HP  .. ' atk ' .. self.attack .. ' def ' .. self.defense .. ' spd ' .. self.speed)
    self:calculateStats()
	--print(self.name .. ' lvl ' .. self.level  .. ' hp ' .. self.HP  .. ' atk ' .. self.attack .. ' def ' .. self.defense .. ' spd ' .. self.speed)
...
function Pokemon:statsLevelUp()
	...
	--print(self.name .. '      ' .. ' hp ' .. HPIncrease .. ' atk ' .. attackIncrease .. ' def ' .. defenseIncrease .. ' spd ' .. speedIncrease)
