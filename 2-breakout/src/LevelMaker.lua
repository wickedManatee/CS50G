...
function LevelMaker.createMap(level)
	...
	print('color ' .. tostring(highestColor))
    ...
    for y = 1, numRows do
		...
		-- whether we want to enable locked bricks for row
        local lockPattern = math.random(1, 2) == 1 and true or false
        ...
        for x = 1, numCols do
			...
			print('final color/tier ' .. tostring(b.color) .. '/' .. tostring(b.tier))
