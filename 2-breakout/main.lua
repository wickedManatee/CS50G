...
function love.load()
    ...
    gTextures = {
		...
		['bricks'] = love.graphics.newImage('graphics/blocks.png'),
...
function renderScore(score, recoverPoints, paddleUpgradePoints)
    love.graphics.setFont(gFonts['small'])
    love.graphics.print('Score:', VIRTUAL_WIDTH - 60, 5)
    love.graphics.printf(tostring(score), VIRTUAL_WIDTH - 50, 5, 40, 'right')
	love.graphics.draw(gTextures['main'], gFrames['powerups'][3], VIRTUAL_WIDTH- 64, 15)
	love.graphics.printf(' at ' .. tostring(paddleUpgradePoints), VIRTUAL_WIDTH - 49, 19, 60, 'left')
	love.graphics.draw(gTextures['hearts'], gFrames['hearts'][1], VIRTUAL_WIDTH- 60, 30)
	love.graphics.printf(' at ' .. tostring(recoverPoints), VIRTUAL_WIDTH - 49, 30, 60, 'left')
